...
const BannerSections = (props) => {
  ...
  const getPreDetailsDataHandler = async () => {
    try {
      ...
      if (res.data.statusCode === 200) {
        console.log('responseCode-----', res.data.result)
  ...
  const updateContentHandler = async (file) => {
    setIsSubmit(true)
    if (bannerDescription !== '' && title !== '' && urlVideo !== '') {
      if (bannerDescription.length <= 140) {
                  ...
                  <Box mb={2}>
                    <Grid container spacing={0}>
                      ...
                      <Grid item xs={12} md={12}>
                        ...
                        {tooLongText && (
                          <FormHelperText error>
                            *You can not enter more than 140 charachters.
                          </FormHelperText>
                        )}
                      </Grid>
                    </Grid>
