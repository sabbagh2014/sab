...
const { userCheck, findUser, findUserData, updateUser } = userServices;
...
export class bidController {
    ...
    async createBid(req, res, next) {
        ...
        try {
            ...
            await updateOrder({ _id: orderCheck._id }, { $addToSet: { bidId: result._id }, $set: { lastBidder: userResult._id } });
            await updateUser({ _id: userResult._id }, { $inc: { massBalance: -Number(validatedBody.bid) } })
